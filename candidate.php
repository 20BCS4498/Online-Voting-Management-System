...
<div class="container">
         ...
         <div class="row">
           ...
           <p class="text-center" style="margin-bottom: 50px;">Vote for your Candidate</p>
         </div>
         <?php 
...
?>
        <!-- Card Start -->
          <div class="col-md-3.5 " style=" margin-left:30px; padding-top: 30px;">
                <div class="card" style="width: 20rem;">
                  <img class="card-img-top" src="img/9.svg" alt="shinzo" height="355px">
                  <div class="card-body">
