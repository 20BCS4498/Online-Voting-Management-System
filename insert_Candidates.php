        ...
        <div class="row">
            <div class="col-md-6" >
                ...
                <table>
                    ...
                    <tr>
                        <td class="td-1">Aadhar Number :</td>
                        <td class="td-1"><input  required type="number" style="text-align: left;" name="aadharNumber"></td>
                    </tr>
                    <tr>
                        <td class="td-1">Aadhar Card :</td>
                        <td class="td-1"><input  required type="file" style="text-align: left;" name="aadharCard"></td>
                    </tr>
